...
g++ -std=c++17 -c src/composer.cpp -o build/composer.o
g++ -std=c++17 -c src/blocks/ethernet.cpp -o build/ethernet.o
g++ -std=c++17 -c src/utilities/utilities.cpp -o build/utilities.o
